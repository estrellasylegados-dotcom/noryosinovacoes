    ...
    <>
      <section className="hero-bleed tech-grid glow-cyan relative overflow-hidden border-b border-[var(--hairline)] pb-16 pt-[calc(var(--header-h)+72px)]">
        <Container className="max-w-3xl">
          ...
          <h1 className="t-display text-[clamp(2.25rem,1.6rem+2.6vw,3.4rem)]">Uma estrutura pensada para durar.</h1>
      ...
      <section className="section">
        <Container className="grid gap-10 max-w-3xl">
          <Reveal>
            <h2 className="t-h3">Empresa nova. O jeito de trabalhar, não.</h2>
          ...
          <Reveal delay={70}>
            <h2 className="t-h3">Por trás da Noryos</h2>
            <p className="mt-3 text-[var(--color-text-muted)]">
          ...
          <Reveal delay={140}>
            <h2 className="t-h3">O que a Noryos não faz</h2>
            <p className="mt-3 text-[var(--color-text-muted)]">
