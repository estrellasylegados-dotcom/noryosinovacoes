...
export function FloatingWhatsapp() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[var(--color-cyan)] text-[var(--color-ink)] shadow-[var(--shadow-elevated)] transition-transform hover:scale-105"
    >
